...
# "Individual household electric power consumption Data Set" to plot Global Active Power (kilowatts) over time
...
#
## OUTPUT
# A png file with the corresponding plot- plot2.png 
#########################################################################
